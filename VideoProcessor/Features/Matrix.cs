...
namespace VideoProcessor.Features
{
    ...
    public static class Matrix
    {
            ...
            if (!symmetric)
            {
                for (int i = 0; i < size; i++)
                    for (int j = 0; j < size; j++)
                        r[i, j] = Tools.Random.NextDouble() * (maxValue - minValue) + minValue;
            }
            else
            {
                for (int i = 0; i < size; i++)
        ...
        public static double[] Random(int size, double minValue, double maxValue)
        {
            ...
            for (int i = 0; i < size; i++)
                r[i] = Tools.Random.NextDouble() * (maxValue - minValue) + minValue;
        ...
        {
            return indexes.Select(index => data[index]).ToArray(); ;
        }
        ...
        public static double[] Round(double[] value, int decimals)
        {
            ...
            for (int i = 0; i < r.Length; i++)
                r[i] = System.Math.Round(value[i], decimals);
            return r;
        }
        ...
        public static double[] Ceiling(double[] value)
        {
            double[] r = new double[value.Length];
            for (int i = 0; i < r.Length; i++)
                r[i] = System.Math.Ceiling(value[i]);
            return r;
        }
